...
def main():
    print('1 - Побудувати розклад за допомогою жадібного алгоритму(А1) для досягнення максимального доходу')
    print('2 - Побудувати розклад за допомогою генетичного алгоритму без локального покращення(А2) для досягнення максимального доходу')
    print('3 - Побудувати розклад за допомогою генетичного алгоритму з локальним покращенням(А3) для досягнення максимального доходу')
